function AboutSection() {
    ...
    <div>
        ...
        I was a competitive swimmer for over a decade and my long-term goal had always been to be a member of a fast Division 1 Swim team.
        After 6 years of training and competing I earned the opportunity to try-out to walk-on to the NCAA Men's Utah Swim and Dive team. 
        Once I made the team, I worked to prove that I belonged on the team and eventually in one
        of my events I went the 8th fastest time in the history of Utah Swim and Dive.
        </p>
        <p>
        That is just a short testiment to my work ethic and what I can achieve including this website!
        So, thank you for stopping by and I hope you enjoy!
        </p>
